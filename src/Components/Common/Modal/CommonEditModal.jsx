    ...
    return (
        <Modal isOpen={props.isOpen} toggle={props.toggler} size={props.size} centered>
            ...
            <ModalBody className={props.bodyClass}>
                <Label className="col-form-label" for="recipient-name">{'Name'}<span style={{color:'red'}}>*</span></Label>
                ...
                <Btn className attrBtn={{ color: 'success', className: `btn ${(props.formValue.status) ? 'add-subcategory-btn-active' : 'add-subcategory-btn-de-active'}` }}>{(props.formValue.status) ? 'Active' : 'De Active'}</Btn>
            </ModalBody>
            <ModalFooter>
