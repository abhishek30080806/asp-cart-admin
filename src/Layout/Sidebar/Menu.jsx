          ...
          [
            {
              ...
              "type": "sub",
              "children": [
                { "title": "Mobile Phones", "type": "link", "path": `${process.env.PUBLIC_URL}/electronics/mobile-phones` },
                { "title": "Laptops", "type": "link", "path": `${process.env.PUBLIC_URL}/electronics/laptops` },
                { "title": "Headphones", "type": "link", "path": `${process.env.PUBLIC_URL}/electronics/headphones` },
                { "title": "Cameras", "type": "link", "path": `${process.env.PUBLIC_URL}/electronics/cameras` },
                { "title": "Smartwatches", "type": "link", "path": `${process.env.PUBLIC_URL}/electronics/smartwatches` }
              ]
            },
            {
              ...
              "type": "sub",
              "children": [
                { "title": "Refrigerators", "type": "link", "path": `${process.env.PUBLIC_URL}/home-appliances/refrigerators` },
                { "title": "Washing Machines", "type": "link", "path": `${process.env.PUBLIC_URL}/home-appliances/washing-machines` },
                { "title": "Microwaves", "type": "link", "path": `${process.env.PUBLIC_URL}/home-appliances/microwaves` },
                { "title": "Air Conditioners", "type": "link", "path": `${process.env.PUBLIC_URL}/home-appliances/air-conditioners` },
                { "title": "Dishwashers", "type": "link", "path": `${process.env.PUBLIC_URL}/home-appliances/dishwashers` }
              ]
            },
            {
              "title": "Clothing",
              "type": "sub",
              "children": [
                { "title": "Men's Clothing", "type": "link", "path": `${process.env.PUBLIC_URL}/clothing/mens-clothing` },
                { "title": "Women's Clothing", "type": "link", "path": `${process.env.PUBLIC_URL}/clothing/womens-clothing` },
                { "title": "Kids' Clothing", "type": "link", "path": `${process.env.PUBLIC_URL}/clothing/kids-clothing` },
                { "title": "Sportswear", "type": "link", "path": `${process.env.PUBLIC_URL}/clothing/sportswear` },
                { "title": "Accessories", "type": "link", "path": `${process.env.PUBLIC_URL}/clothing/accessories` }
              ]
            },
          ],
      },
